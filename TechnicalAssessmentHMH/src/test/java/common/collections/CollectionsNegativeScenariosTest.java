...
public class CollectionsNegativeScenariosTest extends AbstractTest{

	private static final Logger LOGGER = Logger.getLogger(CitiesNegativeScenariosTest.class.getName());
	private static final String CUISINESS_KEY = "cuisines";
    ...
    private static final Double PARAMETER_LAT_NUMBER = 53.3434;
    ...
    public void testStatusVerify(String parameters) throws Exception {
        ...
        JSONObject result = getHttpResponse(CUISINESS_KEY + parameters);
    ...
    /***
     * Verifies the message value key.
     * For this test the @DataProvider method was used.
     * Receives parameter from @DataProvider method:
     * @param parameters: is a combination of different parameters
     * @throws Exception 
